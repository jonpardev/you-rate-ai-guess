...
export const OPENAI_REQUEST = returnEnvOrThrowError('OPENAI_REQUEST');
export const OPENAI_PROMPT = returnEnvOrThrowError('OPENAI_PROMPT');
...
export const FIREBASE_KEY = process.env.FIREBASE_KEY?.replace(/\\n/gm, "\n");